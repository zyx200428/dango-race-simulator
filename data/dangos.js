...
const DANGO_LIBRARY = {
  ...
  yuno: { id:"yuno", name:"尤诺", short:"尤", group:"C", cls:"phoebe", img:"assets/C2.png", skillName:"中点重排", skillDescription:"每场一次。经过第 18 格后，在本次移动结算结束时将所有普通团子按传送前排名顺序重排到尤诺所在格。", skillType:"midpoint_all_ranked_stack_teleport_once", skill:"yuno", skillParams:{ midpoint:18 } },
