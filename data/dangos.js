...
const DANGO_LIBRARY = {
  ...
  augusta: { id:"augusta", name:"奥古斯塔", short:"奥", group:"C", cls:"roccia", img:"assets/C1.png", skillName:"顶端压制", skillDescription:"回合开始时，若处于至少 2 位普通团子的堆叠最顶端，本回合不能主动行动，并在下回合最后行动。", skillType:"round_start_top_skip_force_last_next", skill:"augusta", skillParams:{} },
  yuno: { id:"yuno", name:"尤诺", short:"尤", group:"C", cls:"phoebe", img:"assets/C2.png", skillName:"中点重排", skillDescription:"每场一次。经过第 18 格后进入待触发状态；主动经过、被带着经过或被布大王带着经过都只记录状态；只有尤诺自己的主动行动结束后，才将所有普通团子按触发前排名顺序重排到尤诺所在格；本局最多触发一次。", skillType:"midpoint_all_ranked_stack_teleport_once", skill:"yuno", skillParams:{ midpoint:18 } },
  flololo: { id:"flololo", name:"弗洛洛", short:"弗", group:"C", cls:"cantarella", img:"assets/C3.png", skillName:"底层加速", skillDescription:"回合开始时，若处于至少 2 位普通团子的堆叠最底层，本回合主动行动额外前进 3 格。", skillType:"round_start_bottom_active_move_bonus", skill:"flololo", skillParams:{ bonus:3 } },
