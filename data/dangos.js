...
const DANGO_LIBRARY = {
  ...
  yuno: { id:"yuno", name:"尤诺", short:"尤", group:"C", cls:"phoebe", img:"assets/C2.png", skillName:"中点重排", skillDescription:"每场一次。经过第 18 格后进入待触发状态；仅在尤诺自己的主动行动结束后，将所有普通团子按触发前排名顺序重排到尤诺所在格，排名越高越靠上。", skillType:"midpoint_all_ranked_stack_teleport_once", skill:"yuno", skillParams:{ midpoint:18 } },
