...
const DANGO_LIBRARY = {
  ...
  aemis: { id:"aemis", name:"爱弥斯", short:"爱", group:"B", cls:"camellya", img:"assets/B4.png", skillName:"电子幽灵登场", skillDescription:"每场最多成功传送一次。经过第18格后，自己的主动行动结束时检查前方最近团子并单独传送到其所在格顶端。", skillType:"midpoint_teleport", skill:"ghost", skillParams:{ midpoint:18 } },
