...
const DANGO_LIBRARY = {
  ...
  aemis: { id:"aemis", name:"爱弥斯", short:"爱", group:"B", cls:"camellya", img:"assets/B4.png", skillName:"电子幽灵登场", skillDescription:"经过第18格后进入待触发状态，只有爱弥斯自己主动行动结束后才判定传送；成功时单独传送到前方最近团子所在格顶端，每局最多成功一次。", skillType:"midpoint_teleport", skill:"ghost", skillParams:{ midpoint:18 } },
