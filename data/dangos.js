...
const DANGO_LIBRARY = {
  ...
  augusta: { id:"augusta", name:"奥古斯塔", short:"奥", group:"C", cls:"roccia", img:"assets/C1.png", skillName:"顶端压制", skillDescription:"主动行动前判定：若处于至少 2 个单位的物理堆叠最顶端，本次以 0 步重新落点，并在下回合最后行动；强制最后行动的回合不会再次触发。", skillType:"round_start_top_skip_force_last_next", skill:"augusta", skillParams:{} },
  ...
  flololo: { id:"flololo", name:"弗洛洛", short:"弗", group:"C", cls:"cantarella", img:"assets/C3.png", skillName:"底层加速", skillDescription:"主动行动前判定：若处于至少 2 个单位的物理堆叠最底层，本次主动移动额外前进 3 格。", skillType:"round_start_bottom_active_move_bonus", skill:"flololo", skillParams:{ bonus:3 } },
  changli: { id:"changli", name:"长离", short:"长", group:"C", cls:"danjin", img:"assets/C4.png", skillName:"下层牵制", skillDescription:"回合结束时，若所在物理堆叠下方有任意单位，有 65% 概率下回合最后行动。", skillType:"round_end_below_stack_chance_force_last_next", skill:"changli", skillParams:{ chance:0.65 } },
