...
const DANGO_LIBRARY = {
  ...
  aemis: { id:"aemis", name:"爱弥斯", short:"爱", group:"B", cls:"camellya", img:"assets/B4.png", skillName:"电子幽灵登场", skillDescription:"经过第18格后进入待触发状态；只有爱弥斯自己主动行动结束后才检查是否传送；前方无人则等待；成功传送一次后技能结束。", skillType:"midpoint_teleport", skill:"ghost", skillParams:{ midpoint:18 } },
